...
DEPENDENCY_OUTPUT=$(arduino --pref "boardsmanager.additional.urls=https://github.com/wasdpkj/Microduino-IDE-Support/raw/master/travis/package_Microduino_index_for_travis.json" --save-prefs 2>&1)
