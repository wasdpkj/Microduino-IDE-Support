 ...
 * Webplayer object is serviced with the availaible function.
 */
void loop()
{
        ...
        if (strstr(clientline, "GET / ") != 0) {
          ...
          if (get_arg) {
            ...
            if (strstr(get_arg, "PLAY") != 0) {
              result = Webplayer.playMP3(filename);
              if(result != 0) {
            ...
            //PAUSE
              ...
              if( Webplayer.getState() == playback) {
                Webplayer.pauseMusic();
                Serial.println(F("Pausing"));
              } else if( Webplayer.getState() == paused_playback) {
                Webplayer.resumeMusic();
            ...
            // VOLUME
              ...
              Webplayer.setVolume(val, val); // commit new volume
            ...
            // PLAY SPEED
              ...
              Webplayer.setPlaySpeed(val); // commit new playspeed
