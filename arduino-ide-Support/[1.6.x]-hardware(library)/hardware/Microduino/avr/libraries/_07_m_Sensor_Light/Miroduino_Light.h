...
public:
  Light_D1(uint8_t addr = TSL2561_ADDR_LOW);
  boolean begin(tsl2561IntegrationTime_t _it = TSL2561_INTEGRATIONTIME_13MS, tsl2561Gain_t _gain = TSL2561_GAIN_1X); 
  
  /* TSL2561 Functions */
  void enableAutoGain(bool enable);
  void setIntegrationTime(tsl2561IntegrationTime_t time);
  void setGain(tsl2561Gain_t gain);
  void getBroadbandIr (uint16_t *broadband, uint16_t *ir);
...
private:
  ...
  void enable (void);
  void disable (void);
  void getRaw (uint16_t *broadband, uint16_t *ir);
