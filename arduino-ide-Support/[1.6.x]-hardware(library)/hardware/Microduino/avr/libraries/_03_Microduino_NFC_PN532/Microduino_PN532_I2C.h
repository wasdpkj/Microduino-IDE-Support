...
#ifndef __MICRODUINO_PN532_I2C_H__
#define __MICRODUINO_PN532_I2C_H__
...
#define PN532_ISO14443_3B					(0x03)
#define PN532_JEWEL_TAG						(0x04)
...
class Microduino_PN532_I2C{
 public:
  Microduino_PN532_I2C();
  Microduino_PN532_I2C(int8_t irq);
  uint32_t begin(void);
  ...
  boolean Refresh(uint8_t cardbaudrate);
