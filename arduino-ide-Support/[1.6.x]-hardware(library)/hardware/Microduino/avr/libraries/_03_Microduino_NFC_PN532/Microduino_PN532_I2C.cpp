...
const byte pn532ack[] = {0x00, 0x00, 0xFF, 0x00, 0xFF, 0x00};
const byte pn532response_firmwarevers[] = {0x00, 0xFF, 0x06, 0xFA, 0xD5, 0x03};
...
*/
/**************************************************************************/
Microduino_PN532_I2C::Microduino_PN532_I2C(){
	_irq = -1;
	irqMode = I2C_REC;
}


Microduino_PN532_I2C::Microduino_PN532_I2C(int8_t irq) {
  _irq = irq;
  irqMode = IRQ_REC;
  pinMode(_irq, INPUT);
}
...
*/
/**************************************************************************/
uint32_t Microduino_PN532_I2C::begin() {
...
*/
/**************************************************************************/
void Microduino_PN532_I2C::PrintHex(const byte * data, const uint32_t numBytes)
{
  uint32_t szPos;
...
*/
/**************************************************************************/
void Microduino_PN532_I2C::PrintHexChar(const byte * data, const uint32_t numBytes)
{
  uint32_t szPos;
  for (szPos=0; szPos < numBytes; szPos++) 
  {
...
*/
/**************************************************************************/
uint32_t Microduino_PN532_I2C::getFirmwareVersion(void) {
  uint32_t response;
...
boolean Microduino_PN532_I2C::sendCommandCheckAck(uint8_t *cmd, uint8_t cmdlen, uint16_t timeout) {
  // write the command
...
*/
/**************************************************************************/
boolean Microduino_PN532_I2C::writeGPIO(uint8_t pinstate) {
...
*/
/**************************************************************************/
uint8_t Microduino_PN532_I2C::readGPIO(void) {
...
*/
/**************************************************************************/
boolean Microduino_PN532_I2C::SAMConfig(void) {
  pn532_packetbuffer[0] = PN532_COMMAND_SAMCONFIGURATION;
  pn532_packetbuffer[1] = 0x01; // normal mode;
  pn532_packetbuffer[2] = 0x14; // no timeout is used in this mode.
  pn532_packetbuffer[3] = irqMode; // use IRQ pin!
...
*/
/**************************************************************************/
boolean Microduino_PN532_I2C::setPassiveActivationRetries(uint8_t maxRetries) {
...
boolean Microduino_PN532_I2C::Refresh(uint8_t cardbaudrate){
...
*/
/**************************************************************************/
boolean Microduino_PN532_I2C::readPassiveTargetID(uint8_t cardbaudrate, uint8_t * uid, uint8_t * uidLength) {
...
*/
/**************************************************************************/
bool Microduino_PN532_I2C::mifareclassic_IsFirstBlock (uint32_t uiBlock)
{
...
*/
/**************************************************************************/
bool Microduino_PN532_I2C::mifareclassic_IsTrailerBlock (uint32_t uiBlock)
{
  // Test if we are in the small or big sectors
  if (uiBlock < 128)
...
*/
/**************************************************************************/
uint8_t Microduino_PN532_I2C::mifareclassic_AuthenticateBlock (uint8_t * uid, uint8_t uidLen, uint32_t blockNumber, uint8_t keyNumber, uint8_t * keyData)
{
  uint8_t len;
  uint8_t i;
...
*/
/**************************************************************************/
uint8_t Microduino_PN532_I2C::mifareclassic_ReadDataBlock (uint8_t blockNumber, uint8_t * data)
{
  #ifdef MIFARE_DEBUG
...
*/
/**************************************************************************/
uint8_t Microduino_PN532_I2C::mifareclassic_WriteDataBlock (uint8_t blockNumber, uint8_t * data)
{
  #ifdef MIFARE_DEBUG
...
*/
/**************************************************************************/
uint8_t Microduino_PN532_I2C::mifareclassic_FormatNDEF (void)
{
...
*/
/**************************************************************************/
uint8_t Microduino_PN532_I2C::mifareclassic_WriteNDEFURI (uint8_t sectorNumber, uint8_t uriIdentifier, const char * url)
{
...
*/
/**************************************************************************/
uint8_t Microduino_PN532_I2C::mifareultralight_ReadPage (uint8_t page, uint8_t * buffer)
{
  if (page >= 64)
  {
    #ifdef MIFARE_DEBUG
...
*/ 
/**************************************************************************/ 
uint8_t Microduino_PN532_I2C::mifareultralight_WritePage (uint8_t page, uint8_t *buffer) 
{ 
  /* Prepare the first command */ 
  pn532_packetbuffer[0] = PN532_COMMAND_INDATAEXCHANGE; 
  pn532_packetbuffer[1] = 1;                           /* Card number */ 
...
*/
/**************************************************************************/
boolean Microduino_PN532_I2C::readackframe(void) {
  uint8_t ackbuff[6];
...
*/
/**************************************************************************/
uint8_t Microduino_PN532_I2C::wirereadstatus(void) {
  if(irqMode == IRQ_REC){
...
*/
/**************************************************************************/
void Microduino_PN532_I2C::wirereaddata(uint8_t* buff, uint8_t n) {
...
*/
/**************************************************************************/
void Microduino_PN532_I2C::wiresendcommand(uint8_t* cmd, uint8_t cmdlen) {
  uint8_t checksum;
  cmdlen++;
...
*/
/**************************************************************************/
boolean Microduino_PN532_I2C::waitUntilReady(uint16_t timeout) {
  uint16_t timer = 0;
...
*/
/**************************************************************************/
boolean Microduino_PN532_I2C::inDataExchange(uint8_t * send, uint8_t sendLength, uint8_t * response, uint8_t * responseLength) {
...
*/
/**************************************************************************/
boolean Microduino_PN532_I2C::inListPassiveTarget() {
