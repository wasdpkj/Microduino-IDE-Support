...
#ifndef _MICRODUINO_COLOR_DETECTOR_H_
#define _MICRODUINO_COLOR_DETECTOR_H_
...
public:
  ...
  void begin(uint8_t mode = TCS3414_FREEMODE);
  void start();
  void stop();
  ...
  void enableADC();
  void powerOn();
  void setLevelThreshold(uint8_t reg, uint16_t thresh);
